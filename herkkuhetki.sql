...
insert into product (name,price,description,image,stock,category_id, theme_id) values ('Kissimirrin kikkareet',0.99,'Lasten suosiossa oleva pieni salmiakkikarkkilaatikko. Paino 23g.','images/imagenotfound', 34, 13, 3);
...
insert into product (name,price,description,image,stock,category_id, theme_id) values ('Yllätysmuna',3.56,'Laita suuhusi ja saat yllätyksen, vaikka et ehkä haluaisikaan.','images/imagenotfound', 19, 17, 3);
